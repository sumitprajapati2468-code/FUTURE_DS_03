...
## Executive Overview
This analysis used 3,128 cleaned rows derived from 3,128 raw rows. The dataset covers 6 months, 5 channels, 2 campaigns per channel, and 2 audience segments.
...
| channel       | object  |                0 |               5 |
| source        | object  |                0 |              20 |
| campaign      | object  |                0 |              11 |
| segment       | object  |                0 |               2 |
| stage         | object  |                0 |               6 |
| stage_order   | int64   |                0 |               6 |
| stage_count   | int64   |                0 |             729 |
| cost          | float64 |                0 |             513 |
| revenue       | float64 |                0 |             498 |
